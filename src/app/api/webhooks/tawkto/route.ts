...
const WEBHOOK_SECRETS = [
  ...
  process.env.TAWKTO_WEBHOOK_SECRET_VISAAGENTSINDEL,
  process.env.TAWKTO_WEBHOOK_SECRET_VISAAGENTSINMUM,
  process.env.TAWKTO_WEBHOOK_SECRET_VISAAGENTSINBLR,
  process.env.TAWKTO_WEBHOOK_SECRET_VISAAGENTSINCHN,
  process.env.TAWKTO_WEBHOOK_SECRET_VISAAGENTSINKOL,
